...
from cosmos_transfer1.utils.intermediates import create_gif, SAVE_INTERMEDIATES
            ...
            if device_rank == 0:
                ...
                if SAVE_INTERMEDIATES:
                    for j, intermediate_video in enumerate(intermediate_videos):
                        intermediate_video_save_path = os.path.join(intermediate_video_save_subfolder, f"intermediate_video_{j}.mp4")
                        save_video(
